...
SRC_URI="
	https://github.com/visrosa/Tangent/releases/download/v${PV}/tangent-${PV}-source.tar.gz
		-> ${P}-source.tar.gz
	https://github.com/visrosa/Tangent/releases/download/v${PV}/tangent-${PV}-vendor.tar.zst
		-> ${P}-vendor.tar.zst
"
